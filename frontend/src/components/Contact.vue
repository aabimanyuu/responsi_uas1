...
function openGmail() {
  const email = 'abimanyusaf@gmail.com';
...
<a href="https://github.com/aabimanyuu" target="_blank" class="text-gray-400 hover:text-white transition-colors duration-300">GitHub</a>

<a href="#" target="_blank" class="text-gray-400 hover:text-white transition-colors duration-300">LinkedIn</a>

</div>
<p class="text-gray-500">&copy; {{ new Date().getFullYear() }} Abimanyu S. All rights reserved.
</p>
</div>
</footer>
</template>
